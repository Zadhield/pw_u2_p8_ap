<template>
  <div class="container">
    ...
    <table border="1">
      ...
      <tbody>
        <tr v-for="{nombre, apellido, edad, carrera, correo} in lista" :key="nombre">
          <td>{{ nombre }}</td>
          <td>{{ apellido }}</td>
          <td>{{ edad }}</td>
          <td>{{ carrera }}</td>
    ...
    return {
      ...
      lista: [
        ...
        },
        {
          ...
          correo: "pedro.guaycha@example.com",
        },
        {
          nombre: "Juan",
          apellido: "Teran",
        ...
        },
        {
          ...
          edad: 24,
          carrera: "Medicina",
          correo: "marco.andrade@example.com",
        },
        {
          nombre: "Andrea",
          apellido: "Castillo",
        ...
        },
        {
          ...
          correo: "marcelo.lopez@example.com",
        },
        {
          nombre: "Alejandra",
          apellido: "Pineda",
          ...
          correo: "alejandra.pineda@example.com",
        },
      ],
      mostrar:false,
    };
